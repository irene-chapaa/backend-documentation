---
sidebar_label: "Generate User Wallets"
title: "Generate User Wallets Endpoint"
description: "Generate User Wallets API endpoint description"
---
...
```
POST {{Url}}/api/v1/wallets/generate-wallets
```
...
```json
{
  "userId": "af8cd8ff-bd30-4ca5-bf7c-c52fea38ae53"
}
```
