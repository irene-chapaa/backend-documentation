---
sidebar_label: "Get Transactions by User Id"
title: "Get Transactions by User Id Endpoint"
description: "Get Transactions by User Id API endpoint description"
---
...
```
GET {{Url}}/api/v1/payments/transactions/user/:userId
```
